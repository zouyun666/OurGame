...
int GameData::remainedTime() const
{
    return  m_remainedTime;
}

void GameData::setRemainedTime(const int remainedTime)
{
...
bool GameData::load() //const SaveFormat &saveFormat
{
    //导入json数据文件
...
bool GameData::save()//People::SaveFormat saveFoemat
{
